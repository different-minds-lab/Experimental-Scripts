...
window.jsPsych = (function() {
  ...
  core.loadFail = function(message){
    message = message || '<p>The experiment failed to load. Please try refreshing your page, this may take a moment!</p>';
    loadfail = true;
...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    if(progress_bar){
      ...
      pb_html += "<div id='main' style='max-width:600;'>Please wait while the experiment loads. This may take a moment.</div>"
      pb_html += "</div>";
