...
for (let j = 0; j < 2; j++) {
    ...
    for (let i = 0; i < img_queryStimuli.length; i++) {
        ...
        // console.log("Selected Image Query:", current_query); 
...
if (!hideSurvey) { timeline.push(v_Num, age, gender, S1_TimeLookingAtRocks, S1_followUpTimeLookingAtRocks, S1_TakenGeoCourse, S1_followUpTakenGeoCourse, S1_followUpPostSecGeoCourse, ability_n_profession) }
...
// console.log("Order of Label Trial Queries (Shuffled):");
...
if (!hideSurvey) { timeline.push(S1_FairRockID_CategoryLevel, S1_followUpFairRockID_CategoryLevel, S1_FairRockID_TypeLevel, S1_followUpFairRockID_TypeLevel, TechnicalDifficulties, yes_to_TechDiff) }
